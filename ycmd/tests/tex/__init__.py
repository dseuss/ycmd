...
def setUpPackage():
  ...
  shared_app = SetUpApp()
  WaitUntilCompleterServerReady( shared_app, 'tex' )
...
def tearDownPackage():
  ...
  StopCompleterServer( shared_app, 'tex' )
...
def IsolatedYcmd( custom_options = {} ):
  ...
  Example usage:
    ...
    @IsolatedYcmd( { 'tex_bibfiles': '/some/path/to/references.bib' } )
